...
@section('content')
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            @foreach ($busModels as $item)
                                ...
                                @include('pages.BusModels.edit')

                                <!--  page of delete_modal_city -->
                                @include('pages.BusModels.delete')


                            @endforeach
                        </table>

                        <div> {{$busModels->links('pagination::bootstrap-4')}}</div>
                    </div>
                </div>
            </div>
        </div>
       ...
       @include('pages.BusModels.create')
    </div>
