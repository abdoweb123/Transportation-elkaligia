...
@section('content')
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            @foreach ($busOwners as $item)
                                ...
                                @include('pages.BusOwners.edit')

                                <!--  page of delete_modal_city -->
                                @include('pages.BusOwners.delete')


                            @endforeach
                        </table>

                        <div> {{$busOwners->links('pagination::bootstrap-4')}}</div>
                    </div>
                </div>
            </div>
        </div>
       ...
       @include('pages.BusOwners.create')
    </div>
