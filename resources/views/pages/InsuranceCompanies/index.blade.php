...
@section('content')
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            @foreach ($insuranceCompanies as $item)
                                ...
                                @include('pages.InsuranceCompanies.edit')

                                <!--  page of delete_modal_city -->
                                @include('pages.InsuranceCompanies.delete')


                            @endforeach
                        </table>

                        <div> {{$insuranceCompanies->links('pagination::bootstrap-4')}}</div>
                    </div>
                </div>
            </div>
        </div>
       ...
       @include('pages.InsuranceCompanies.create')
    </div>
