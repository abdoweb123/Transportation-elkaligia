...
{{--                            @method('PUT')--}}
                            ...
                            <div class="row">
                                <div class="section-field col">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" name="name"
                                           value="{{ old('name', $employee->name) }}" autocomplete="name" required readonly="">
                                    @error('name')
                                ...
                                <div class="col">
                                    ...
                                    <input class="form-control" name="code" value="{{$employee->code}}" required readonly="">
                                </div>
                                <div class="section-field col">
                                    <label class="mb-10" for="name">المكتب :</label>
                                    <input type="text" value="{{ $employee->office->name }}" class="form-control" readonly>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="section-field col">
                                    ...
                                    <input id="email" type="email"
                                           ...
                                           value="{{ old('email',$employee->email) }}"  autocomplete="email" required readonly="">
                                ...
                                <div class="section-field col">
                                    ...
                                    <input type="text" value="{{ $employee->department->name }}" class="form-control" readonly>
                                </div>
                                <div class="section-field col">
                                    <label class="mb-10" for="name">الوظيفة :</label>
                                    <input type="text" value="{{ $employee->employeeJob->name }}" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="section-field col">
                                    ...
                                    <input type="text" value="{{ $employee->employeeSituation->name }}" class="form-control" readonly>
                                </div>
                                <div class="col">
                                    <label class="mb-10" for="name">الدرجة :</label>
                                    <select class="form-control mr-sm-2 p-2" name="degree" required readonly="">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="date" class="form-control" name="birthdate" value="{{$employee->birthdate}}" required readonly="">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <input type="date" class="form-control" name="appointDate" value="{{$employee->appointDate}}" required readonly="">
                                </div>
                                <div class="col-4">
                                    <label class="mb-10" for="name">الحالة :</label>
                                    <select class="form-control mr-sm-2 p-2" name="active" required readonly="">
