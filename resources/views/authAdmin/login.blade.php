            ...
            <div class="row justify-content-center no-gutters vertical-align">
                <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                    ...
                    <div class="login-fancy">
                        <h2 class="text-white mb-20 font-weight-bold">{{$company_arabic_name}}!</h2>
                        <p class="mb-20 text-white">أهلا بكم في تطبيق {{$company_arabic_name}} لخدمات النقل والرحلات</p>
